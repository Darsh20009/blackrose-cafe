...
import tasaliStaffLogo from "@assets/employee-logo.png";
...
export default function EmployeeSplash() {
  ...
  useEffect(() => {
    document.title = tc("نظام الموظفين - TASALI QURUMSH SYSTEMS | نظام إدارة متكامل", "Employee System - TASALI QURUMSH SYSTEMS | Integrated Management");
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', tc('نظام إدارة الموظفين والعمليات في TASALI QURUMSH SYSTEMS', 'Employee and operations management system for TASALI QURUMSH SYSTEMS'));
