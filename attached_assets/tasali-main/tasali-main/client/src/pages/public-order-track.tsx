    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4" dir={isAr ? 'rtl' : 'ltr'}>
        <div className="text-center space-y-4">
          <img src={blackroseLogo} alt="Tasali Qurumsh" className="h-16 mx-auto object-contain" />
    ...
    <div className="min-h-screen bg-gray-50" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <div className="bg-black text-white py-5 px-4">
        <div className="max-w-lg mx-auto flex flex-col items-center gap-2">
          <img src={blackroseLogo} alt="Tasali Qurumsh" className="h-14 object-contain" />
          <h1 className="text-base font-bold tracking-widest text-white/90 uppercase">Tasali Qurumsh</h1>
        ...
        {order && !isCancelled && (
          <>
            ...
            <p className="text-center text-xs text-gray-400 pb-4">
              {t('tracking.footer_quote')} — TASALI QURUMSH
            </p>
          </>
        )}
