          ...
          <div className="flex-1 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                <span className="text-xs text-muted-foreground">{tc('مدعوم بـ', 'Powered by')} Gemini 2.0 Flash</span>
              </div>
            </div>
          </div>
            ...
            <CardContent className="p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-amber-600 dark:text-amber-500 text-xs mt-1">
                  {tc('لتفعيل الذكاء الاصطناعي، أضف متغير البيئة', 'To activate AI, add the environment variable')}{" "}
                  ...
                  {tc('من', 'from')} <a href="https://openrouter.ai" target="_blank" className="text-amber-600 underline">openrouter.ai</a>
                </p>
              </div>
            </CardContent>
          </Card>
