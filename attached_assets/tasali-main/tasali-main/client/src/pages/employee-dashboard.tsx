...
export default function EmployeeDashboard() {
  ...
  // Set SEO metadata
  useEffect(() => {
    document.title = "Employee Dashboard - TASALI QURUMSH | Order Management";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', 'TASALI QURUMSH Employee Dashboard - Track orders, leave requests and notifications');
  }, []);
                    ...
                    <div className="bg-gradient-to-r from-primary via-primary to-primary/80 p-6 relative">
                      <div className="flex items-center justify-center gap-4 mb-2">
                        <div className="w-20 h-20 flex items-center justify-center shadow-lg rounded-lg">
                          <img src={blackroseLogoStaff} alt={brand.shortNameEn} className="w-full h-full object-contain rounded-lg" />
                        </div>
                        <div className="text-white text-right">
                          <h3 className="text-2xl font-bold">{brand.shortNameEn}</h3>
