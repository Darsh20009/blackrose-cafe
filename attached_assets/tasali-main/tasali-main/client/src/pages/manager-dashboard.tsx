...
export default function ManagerDashboard() {
 ...
 // Set SEO metadata
 useEffect(() => {
   document.title = "لوحة تحكم المدير - TASALI QURUMSH | إدارة المبيعات والعمليات";
   const metaDesc = document.querySelector('meta[name="description"]');
   if (metaDesc) metaDesc.setAttribute('content', 'لوحة تحكم المدير في TASALI QURUMSH - إدارة شاملة للمبيعات والموظفين والفروع والمخزون');
 }, []);
