                              ...
                              <Button 
                                ...
                                onClick={(e) => {
                                  ...
                                  toast({
                                    ...
                                    description: tc("سيتم خصم قيمة الطلب من رصيد بطاقة تسالي الخاصة بك", "The order value will be deducted from your card balance"),
                                  });
                                }}
                              >
                                <Zap className="w-4 h-4 ml-2" />
                                {tc("ادفع ببطاقة تسالي (كوبي)", "Pay with TASALI Card (Copy)")}
                              </Button>
                               {foundCard && (
                              <Button 
                                size="sm"
