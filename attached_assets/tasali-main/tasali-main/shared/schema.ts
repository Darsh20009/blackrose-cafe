...
const TaxInvoiceSchema = new Schema<ITaxInvoice>({
  ...
  sellerName: { type: String, required: true, default: 'TASALI QURUMSH' },
  sellerNameEn: { type: String, default: 'TASALI QURUMSH' },
  sellerVatNumber: { type: String, required: true, default: '' },
  sellerCrNumber: { type: String },
  sellerAddress: { type: String, required: true, default: 'المملكة العربية السعودية' },
