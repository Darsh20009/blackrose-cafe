            ...
            <Select value={settings.mode} onValueChange={(v: any) => { updateSetting('mode', v); setRelayStatus(null); setNetworkStatus(null); }}>
              ...
              <SelectContent>
                <SelectItem value="bluetooth">
                  <span className="flex items-center gap-1"><Bluetooth className="w-3 h-3 text-blue-500" /> {tc("بلوتوث ⭐", "Bluetooth ⭐")}</span>
                </SelectItem>
                <SelectItem value="webusb">
                  <span className="flex items-center gap-1"><Usb className="w-3 h-3 text-gray-600" /> {tc("USB سلكي", "Wired USB")}</span>
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
