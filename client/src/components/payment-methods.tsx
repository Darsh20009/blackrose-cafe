                     ...
                     <div className="flex flex-col items-center justify-center my-auto">
                          <div className="bg-white/10 backdrop-blur rounded-lg p-4 space-y-3 text-center w-full">
                            ...
                            <div className="space-y-2">
                              <Button 
                                size="sm"
                                className="w-full bg-primary hover:bg-primary/90 text-white transition-all duration-300 shadow-lg border-0"
                                onClick={(e) => {
                                  e.stopPropagation();
                                  ...
                                  toast({
                                    ...
                                    description: tc("سيتم خصم قيمة الطلب من رصيد بطاقة بلاك روز الخاصة بك", "The order value will be deducted from your card balance"),
                                  });
                                }}
                              >
                                <Zap className="w-4 h-4 ml-2" />
                                {tc("ادفع ببطاقة بلاك روز (كوبي)", "Pay with Black Rose Card (Copy)")}
                              </Button>
                               {foundCard && (
                              <Button 
                                size="sm"
