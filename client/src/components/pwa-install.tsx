...
const G = "#BE1845";
const G_DIM = "rgba(190,24,69,0.12)";
const G_BORDER = "rgba(190,24,69,0.22)";
  ...
  return (
    <img
      ...
      style={{
        ...
        objectFit: "cover",
        flexShrink: 0,
        boxShadow: `0 6px 20px rgba(190,24,69,0.28), 0 2px 6px rgba(0,0,0,0.4)`,
      }}
    />
  );
}
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 14, padding: "0 20px 14px" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ color: "#fff", fontWeight: 800, fontSize: 17, margin: 0, lineHeight: 1.2 }}>BLACK ROSE CAFE</p>
        <p style={{ color: "rgba(255,255,255,0.35)", fontSize: 11, margin: "2px 0 5px" }}>blackrose.com.sa</p>
        <Stars />
      </div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ color: "rgba(255,255,255,0.4)", fontSize: 11 }}>blackrose.com.sa</span>
      </div>
      <div style={{
    ...
    >
      <div
        ...
        style={{
          ...
          overflow: "hidden",
          border: "1px solid rgba(255,255,255,0.07)",
          boxShadow: "0 -24px 80px rgba(0,0,0,0.7), 0 0 0 1px rgba(190,24,69,0.1)",
        ...
        <div style={{ padding: "0 20px 8px", display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          <Step n="٣" title='اضغط "Add" في الأعلى'>
            <div style={{
              ...
              <AppIcon size={32} />
              <div>
                <p style={{ color: "rgba(255,255,255,0.8)", fontSize: 13, fontWeight: 600, margin: 0 }}>BLACK ROSE CAFE</p>
        ...
        <div style={{ padding: "20px 20px", paddingBottom: isIPad ? 20 : "calc(20px + env(safe-area-inset-bottom))" }}>
          <button
            ...
            style={{
              ...
              background: `linear-gradient(135deg, ${G} 0%, #8B0B2A 100%)`,
...
function AndroidPrompt({ onInstall, onClose }: { onInstall: () => void; onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ height: 3, background: `linear-gradient(90deg, ${G}, #8B0B2A, ${G})` }} />
        <Handle />
          ...
          <button
            ...
            style={{
              ...
              background: installing
                ? "rgba(190,24,69,0.4)"
                : `linear-gradient(135deg, ${G} 0%, #8B0B2A 100%)`,
              border: "none", color: "#fff", fontSize: 17,
              fontWeight: 800, cursor: installing ? "wait" : "pointer",
              display: "flex", alignItems: "center", justifyContent: "center", gap: 10,
              boxShadow: installing ? "none" : `0 6px 24px rgba(190,24,69,0.4)`,
              transition: "all 0.2s",
            }}
          >
            {installing ? (
...
export function PWAInstallButton({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      style={{ background: `linear-gradient(135deg, ${G}, #8B0B2A)`, boxShadow: "0 4px 16px rgba(190,24,69,0.35)" }}
      onClick={install}
    >
