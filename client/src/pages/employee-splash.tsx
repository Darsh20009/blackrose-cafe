...
export default function EmployeeSplash() {
  ...
  useEffect(() => {
    document.title = tc("نظام الموظفين - BLACK ROSE SYSTEMS | نظام إدارة متكامل", "Employee System - BLACK ROSE SYSTEMS | Integrated Management");
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', tc('نظام إدارة الموظفين والعمليات في BLACK ROSE SYSTEMS', 'Employee and operations management system for BLACK ROSE SYSTEMS'));
