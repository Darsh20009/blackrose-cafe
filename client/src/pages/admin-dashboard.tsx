              ...
              <CardContent className="px-5 pb-4">
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    { label: tc("تحليلات متقدمة", "BI Analytics"), icon: TrendingUp, path: "/manager/bi-analytics", color: "#06b6d4" },
                    { label: tc("تقارير المنتجات", "Product Reports"), icon: ShoppingBag, path: "/admin/reports", color: "#f97316" },
                    { label: tc("تقارير موحدة", "Unified Reports"), icon: Activity, path: "/manager/unified-reports", color: "#8b5cf6" },
                  ].map(item => (
                    <button
                      key={item.path}
