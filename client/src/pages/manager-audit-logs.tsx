...
const ACTION_LABELS: Record<string, string> = {
  ...
  "order.discount": "تطبيق خصم",
  "product.delete": "حذف منتج",
  "product.update": "تعديل منتج",
  "employee.login": "تسجيل دخول",
  "employee.logout": "تسجيل خروج",
  "table.delete": "حذف طاولة",
  "tables.delete_all": "حذف كل الطاولات",
  "print.receipt": "طباعة فاتورة",
  "loyalty.claim": "استبدال نقاط",
};
...
export default function ManagerAuditLogsPage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 bg-white min-h-screen" dir="rtl">
