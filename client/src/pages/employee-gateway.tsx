...
export default function EmployeeGateway() {
  ...
  useEffect(() => {
    document.title = tc("بوابة الموظفين - BLACK ROSE CAFE | نظام الإدارة", "Staff Gateway - BLACK ROSE CAFE | Management System");
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', tc("بوابة دخول الموظفين لنظام إدارة BLACK ROSE CAFE", "Staff login gateway for BLACK ROSE CAFE management system"));
  }, []);
