                    ...
                    return (
                      ...
                      >
                        ...
                        {size.price !== item.price && (
                          <span className="text-xs font-bold">+{(size.price - (typeof item.price === 'number' ? item.price : parseFloat(String(item.price || 0)))).toFixed(2)} <SarIcon /></span>
                        )}
                      </Button>
                    );
                  })}
