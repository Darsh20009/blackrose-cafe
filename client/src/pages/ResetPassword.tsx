...
export default function ResetPassword() {
  ...
  useEffect(() => {
    document.title = tc("إعادة تعيين كلمة المرور - BLACK ROSE CAFE", "Reset Password - BLACK ROSE CAFE");
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', tc('إعادة تعيين كلمة المرور على BLACK ROSE CAFE - أدخل كلمة مرور جديدة آمنة', 'Reset your BLACK ROSE CAFE password - enter a new secure password'));
  }, [tc]);
