...
export default function DeliveryTracking() {
  ...
  useEffect(() => {
    document.title = tc("تتبع التوصيل - BLACK ROSE CAFE", "Delivery Tracking - BLACK ROSE CAFE");
  }, [tc]);
        ...
        {isDelivered && (
          <Card className="bg-green-50 dark:bg-green-950/20 border-green-200">
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-muted-foreground mb-4">{tc("شكراً لطلبك من BLACK ROSE CAFE", "Thank you for ordering from BLACK ROSE CAFE")}</p>
              <Link href="/menu">
                <Button className="w-full">
