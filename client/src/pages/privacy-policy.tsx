      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="space-y-8">
          <div className="text-center border-b pb-8">
            ...
            <p className="text-muted-foreground text-sm">Privacy Policy — BLACK ROSE CAFE</p>
          ...
          <div className="space-y-6 text-sm leading-relaxed">
            <section>
              ...
              <p>
                مرحباً بك في تطبيق BLACK ROSE CAFE. نحن نحترم خصوصيتك ونلتزم بحماية بياناتك الشخصية.
            ...
            <section>
              ...
              <div className="mt-2 p-3 bg-muted rounded-lg text-muted-foreground">
                ...
                <p>الموقع: <a href="https://www.blackrose.com.sa" className="text-primary underline">www.blackrose.com.sa</a></p>
              </div>
            </section>
          </div>
          ...
          <div className="border-t pt-8" dir="ltr">
            ...
            <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
              <p>
                <strong className="text-foreground">1. Introduction.</strong> BLACK ROSE CAFE ("we", "us") respects your privacy.
              ...
              <p>
                <strong className="text-foreground">8. Contact.</strong> BLACK ROSE CAFE ·{" "}
          ...
          <div className="text-center text-xs text-muted-foreground border-t pt-6">
            © 2026 BLACK ROSE CAFE — جميع الحقوق محفوظة
          </div>
        </div>
      </div>
    </div>
