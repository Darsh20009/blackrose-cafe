  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8 min-h-screen flex flex-col justify-center">
        <button
          onClick={() => navigate(`/table-menu/${tableId}`)}
          className="mb-4 flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors self-start"
          data-testid="button-back-table-menu"
        >
