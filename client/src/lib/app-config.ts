...
//
// ╔═══════════════════════════════════════════════════════════════════════════════════════════╗
// ║  BLACK ROSE MASTER FRONTEND CONFIGURATION                                                     ║
...
export const STACK = {
  ...
  payments:  "Geidea (card + Apple Pay), Cash, BLACK ROSE Loyalty Card",
  port:      5000,
